...
ckd_protein is grouped into Tier C: it corresponds to a genuinely existing real-world opposing force, protein intake versus muscle preservation is analogous to the known load-versus-recovery optimal curve in exercise-training periodization.
...
The main text keeps CKD as its one joint-simulation case beyond Banister. The cross-literature reverse-verification case, diuretics, was not written into the main text; its technical details remain in this report's tables and case-tiering notes for reference.
