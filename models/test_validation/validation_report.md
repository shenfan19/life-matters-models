...
The main text keeps CKD as its one joint-simulation case beyond Banister. The two cross-literature reverse-verification cases, HOMA-IR/OGTT and diuretics, were not written into the main text; their technical details remain in this report's tables and case-tiering notes for reference.
